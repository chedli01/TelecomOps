...
public class SubscriptionController {
    ...
    @GetMapping("/{id}")
    public SubscriptionDataDto getSubscriptionById(@PathVariable Long id, @AuthenticationPrincipal User user){
        return subscriptionMapper.mapToDto(subscriptionService.getSubById(id, user.getId()));
    }
